...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3471638072ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=envyhosting&table=pluginsdata">`envyhosting`.`pluginsdata`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=envyhosting&table=users">`envyhosting`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=envyhosting&table=PluginsData">`envyhosting`.`PluginsData`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="472a5e42776e40786d60507c402b3c6f">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="envyhosting" targettable="users">
            ...
            Queried time
                            ...
                            <span class="query">SELECT COUNT(*) AS `Rows`, `Plugins` FROM `users` GROUP BY `Plugins` ORDER BY `Plugins`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="envyhosting" targettable="users">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `users` (`id`, `Licence`, `Email`, `Password`, `Plugins`, `Ip`, `adminMode`) VALUES (NULL, &#039;marga2&#039;, &#039;asdsad&#039;, &#039;xd2&#039;, &#039;EnvyEssentialsPlus, EnvyIdentity&#039;, &#039;192.168.0.1&#039;, &#039;0&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="envyhosting" targettable="users">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `users`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="envyhosting" targettable="pluginsdata">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `pluginsdata`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="envyhosting" targettable="pluginsdata">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `pluginsdata` (`id`, `Name`, `Description`, `Image`, `Price`, `Link`, `Download`, `Configuration`, `Translations`) VALUES (NULL, &#039;dsadsa&#039;, &#039;dsa&#039;, &#039;dasdad&#039;, &#039;2525&#039;, &#039;adasda&#039;, &#039;sda&#039;, &#039;sda&#039;, &#039;dsadas&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="envyhosting" targettable="pluginsdata">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `pluginsdata` (`id`, `Name`, `Description`, `Image`, `Price`, `Link`, `Download`, `Configuration`, `Translations`) VALUES (NULL, &#039;asdsa&#039;, &#039;&#039;, &#039;&#039;, &#039;&#039;, &#039;&#039;, &#039;&#039;, &#039;&#039;, &#039;&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="envyhosting" targettable="pluginsdata">
                            <div class="action_content">
