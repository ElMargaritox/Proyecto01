       ...
       <ul class="navbar-nav me-auto mb-2 mb-md-0">
         ...
         <li class="nav-item">
          ...
          <div class="container">
            ...
            //$databaseManager = new DatabaseManager("sql10.freemysqlhosting.net", "sql10493138", "5qM7FyX9uS", "sql10493138");
            $databaseManager = new DatabaseManager("127.0.0.1", "root", "", "plugins");

                if(isset($databaseManager)){
                  $resultado = $databaseManager->Read("PluginsData");
              ...
              $sql = "INSERT INTO `pluginsdata` (`id`, `Name`, `Description`, `Image`, `Price`) VALUES (NULL, 'Prueba', 'Prueba2', 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/69/How_to_use_icon.svg/1107px-How_to_use_icon.svg.png', 'XD')";
              //$databaseManager->Create("PluginsData", $sql);


                $sql = "DELETE FROM `pluginsdata` WHERE `pluginsdata`.`id` = 20";
                // $databaseManager->Delete("PluginsData", $sql);
              }else{
